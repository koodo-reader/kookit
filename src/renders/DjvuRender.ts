...
class DjvuRender extends GeneralRender {
  djvuBuffer: ArrayBuffer;
  ...
  platform: string;
  constructor(djvuBuffer: ArrayBuffer, config: any) {
    super({ ...config, convertChinese: "Default", format: "PDF" });
    this.djvuBuffer = djvuBuffer;
